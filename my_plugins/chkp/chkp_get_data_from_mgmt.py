...
################# MODULE'S MAIN  ###################### 
def export_data_main(_conf_d, _log):
  ...
  if not _conf_d["mgmt_name"]:
    ...
    return False    
  _conf_d["mgmt_port"]=str(config_d["mgmt_port"])
  _conf_d["data_export_folder"]=str(config_d["data_export_folder"])
  
  # FIXME validate input data in _conf_d
