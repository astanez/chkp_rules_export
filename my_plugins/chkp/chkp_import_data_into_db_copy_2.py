...
def importPackageZonesIntoDb(_dbCon, _mgmt_name, _conf_d, _policy_packages_l, _QLabel_status):
  ...
  for policy_d in _policy_packages_l:
    ...
    policy_zones_d["comments"]=policy_d["comments"]
...
def import_data_into_db_main(_conf_d, _dbCon, _QLabel_status):  
    ...
    for domain in domains_l:
      ...
      # 
      #exit()
      res_importPackagesZones_d=importPackageZonesIntoDb(_dbCon, mgmt_name, _conf_d, packages_d["packages"], _QLabel_status)
      log.info("res_importPackagesZones_d: "+str(res_importPackagesZones_d))
